...
#
# ^syslog - plik zacz zaczynający się od syslog
# cut -d' ' -f2 - dzieli plik po spacji i wybiera drugie pole (numer portu)
# sort -u - sortuje i usuwa powtórzenia
cat dodatkowe/etc-services | grep '^syslog' | cut -d' ' -f2 | sort -u